...
class CsvDGH(_DGH):
    ...
    def getTreeHeight(self):
        ...
        current_node = list(self.hierarchies[list(self.hierarchies.keys())[0]].root.children.keys())[0]
        current_node = self.hierarchies[list(self.hierarchies.keys())[0]].root.children[current_node]
        count = 1
